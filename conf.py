...
BLOG_AUTHOR = "Mark Dewing"  # (translatable)
BLOG_TITLE = "Journey to the Center of the Computer"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://markdewing.github.io/blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "markdewing (at) gmail (dot) com"
BLOG_DESCRIPTION = "Investigations into hardware and software details"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "journeytothecenterofthecomputer"
